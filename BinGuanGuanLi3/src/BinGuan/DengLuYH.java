...
public class DengLuYH extends JFrame implements ActionListener {
	...
	public void panding() {
		 if(GetSQL.userword1.equals(jtf1.getText())&&GetSQL.pwd1.equals(jpf1.getText())) {
			 JOptionPane.showMessageDialog(null,"登录成功！","提示消息",JOptionPane.WARNING_MESSAGE);
			 clear();
			ZhuYeYH zhuyeyh=new ZhuYeYH();
		}
